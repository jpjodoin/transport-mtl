...
public class NotifierDlg extends ActivityWithMenu implements OnClickListener, OnItemSelectedListener, DialogInterface.OnClickListener
{
	...
	// Bloc d'infos r�cuperer via le bundel.
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		{
			if (ArrayDelaiNotification[i] < 10)// Hack pour �viter que la Notification Time soit sur deux lignes
		...
		// Recuperation des informations passer par l'activit� pr�c�dente.
		...
		/* D�claration des boutons de la vue */
	...
	public void onClick(View v)
	{
		...
		if (v == m_buttonSet)
		{
			 ...
			 * l'utilisateur est coh�rente. Coh�rente si la date est pas dans le
			 * pass�e et si l'heure de notification est plus t�t que l'heure de
			 * passage (cliqu�e)
			 */
	 ...
	 * @description: Fonction appel�e lorsque le spinner du d�lai de
	 *               notification bouge. La fonction met � jour l'heure de
	 *               notification en fonction du d�lai de notification choisi
	 *               dans le spinner.
	 * @author: Hocine
	 * @params[in]:
	 * @params[out]:
	...
	public void onItemSelected(AdapterView<?> arg0, View arg1, int nItemCourant, long arg3)
	{
		...
		// Ici on r�cup�re l'annee, le mois et le jour
	 ...
	 * @description: G�re de mettre a jour la date affich�e par le
	 *               boutonDate(spinnerDate) et de et de mettre � jour la date
	 *               que l'utilisateur � choisi pour la notification.
	 * @author: Hocine
	 * @params[in]:
	 * @params[out]:
	 */
	 ...
	 * @author: Hocine
	 * @params[in]: message: message � afficher.
	 */
	 ...
	 * @author: JP
	 * @params[in]: message: Question � afficher
	 */
	...
	private void enregistrerUneAlarmePourNotification()
	{
		...
		// On r�cupere l'information re�ue et on la passe � l'activit� suivante.
